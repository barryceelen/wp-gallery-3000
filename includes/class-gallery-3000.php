	...
	public function enqueue_scripts( $hook_suffix ) {
		...
		wp_localize_script(
			...
			array(
				...
				'fileFrameTitleAdd'          => esc_html__( 'Add Images', 'gallery-3000' ),
				'fileFrameTitleUpdate'       => esc_html__( 'Update Image', 'gallery-3000' ),
				'fileFrameButtonTextAdd'     => esc_html__( 'Add Item', 'gallery-3000' ),
				'fileFrameTButtonTextUpdate' => esc_html__( 'Update Item', 'gallery-3000' ),
